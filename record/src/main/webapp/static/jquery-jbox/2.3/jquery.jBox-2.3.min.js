...
(function (a) {
    a.jBox = function (b, c) {
        ...
        var d = false;//(a.browser.msie && parseInt(a.browser.version) < 7);
        var e = a("#" + c.id);
        if (e.length > 0) {
        ...
        j.push('<div class="jbox-help-button jbox-button-panel" style="height:25px;padding:2px 0 5px 0;display:none;"></div>');
        ...
        j.push('<a class="jbox-close" title="' + a.jBox.languageDefaults.close + '" onmouseover="$(this).addClass(\'jbox-close-hover\');" onmouseout="$(this).removeClass(\'jbox-close-hover\');" style="position:absolute; display:block; cursor:pointer; top:' + (1 + c.border) + "px; right:" + (6 + c.border) + "px; width:15px; height:15px;" + (c.showClose ? "" : "display:none;") + '"></a>');
        if (g) {
            j.push('<div class="jbox-title-panel" style="height:25px;">');
            j.push('<div class="jbox-title' + (c.showIcon == true ? " jbox-title-icon" : (c.showIcon == false ? "" : " " + c.showIcon)) + '" style="float:left; width:' + i + "; line-height:24px;position:absolute;top:5px; padding-left:" + (c.showIcon ? 18 : 5) + 'px;overflow:hidden;text-overflow:ellipsis;word-break:break-all;">' + (c.title == "" ? "&nbsp;" : c.title) + "</div>");
            j.push("</div>")
        }
        ...
        if (h) {
            ...
            var N = o.find("#jbox-content").css({
                ...
                left: 6 ,
                width:o.find("#jbox-states").width()-6
            })
        ...
        var B = function () {
            if (c.isMessager) {
                ...
                o.css({
                    position: "absolute",
                    top: q.offset().top-50 + (c.isTip ? l.scrollTop() : 0) ,
    ...
    a.jBox.defaults = {
        ...
        buttonsFocus: 0,
        loaded: function (b) {}, submit: function (b, c, d) {
            return true
        }, closed: function () {}
    };
    ...
    a.jBox.messagerDefaults = {
        ...
        buttons: {},
        buttonsFocus: 0,
        loaded: function () {}, submit: function (b, c, d) {
            return true
        }, closed: function () {}
    };
    ...
    a.jBox.prompt = function (b, c, d, e) {
        ...
        var g = e.icon == "none" ? "height:auto;" : "min-height:30px;height:auto;";
        var h = [];
        h.push("html:");
    ...
    a.jBox.messager = function (b, c, d, e) {
        ...
        var h = e.icon == "none" ? "height:auto;" : "min-height:30px;height:auto;";
        var i = [];
        i.push("html:");
...
jBoxConfig.defaults = {
    ...
    buttonsFocus: 0,
    loaded: function (a) {}, submit: function (a, b, c) {
        return true
    }, closed: function () {}
};
